...
CREATE INDEX IF NOT EXISTS "idx_customer_archived" ON "customer"("archived");

-- Composite indexes for common query patterns
CREATE INDEX IF NOT EXISTS "idx_customer_business_status" ON "customer"("business_id", "status");
CREATE INDEX IF NOT EXISTS "idx_customer_business_archived" ON "customer"("business_id", "archived");
CREATE INDEX IF NOT EXISTS "idx_order_business_status" ON "order"("business_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_customer_external_id" ON "customer"("external_id") WHERE "external_id" IS NOT NULL;
