...
<ol>
    ...
    <li><strong>Share the Love:</strong> We provide beautiful flyers and forms plus your own online order page and a personal Coordinator Dashboard that updates as orders come in.</li>
                    ...
                    <div className="space-y-4">
                        ...
                        {customer.phone && (
                            <div className="flex items-center gap-4 text-slate-600 dark:text-slate-400">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider mb-0.5">Primary Phone</p>
                        ...
                        {customer.secondary_phone && (
                            <div className="flex items-center gap-4 text-slate-600 dark:text-slate-400">
                                <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0"><Phone size={20} /></div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider mb-0.5">Secondary Phone</p>
                                    <span className="text-sm font-bold text-slate-900 dark:text-white">{customer.secondary_phone}</span>
                                </div>
                            </div>
                        )}
