...
export default function RecipeImporter({ onClose }: { onClose: () => void }) {
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full flex flex-col max-h-[90vh] overflow-hidden border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex justify-between items-center p-6 border-b border-slate-100 dark:border-slate-800">
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mt-1">Upload a CSV or Backup JSON file.</p>
                    </div>
                ...
                <div className="p-8 overflow-y-auto min-h-[300px]">
                    {status === 'idle' || status === 'error' ? (
                            ...
                            >
                                ...
                                {file ? (
                                    ...
                                    <>
                                        ...
                                        <p className="font-bold text-lg text-slate-700 dark:text-slate-300">Click to Upload File</p>
                        ...
                        <div className="space-y-6 text-center py-8">
                            ...
                            <p className="text-slate-500 dark:text-slate-400">Processed file: <span className="font-bold text-slate-700 dark:text-slate-300">{file?.name}</span></p>
                            ...
                            <button
                                onClick={onClose}
                                className="px-8 py-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-xl font-bold transition-colors mt-4"
                            >
                                Done
                            </button>
                        </div>
