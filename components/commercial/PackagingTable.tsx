    ...
    return (
        <>
                                ...
                                <tr key={pkg.id} className="hover:bg-indigo-50/50 dark:hover:bg-slate-800/40 transition-colors group">
                                    <td className="px-6 py-4">
                                        <input
                                            ...
                                            className="w-full min-w-[250px] px-3 py-2 bg-transparent border border-transparent hover:border-slate-300 dark:hover:border-slate-600 focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-800 rounded-lg outline-none transition font-bold text-slate-700 dark:text-slate-200"
                                        />
                                    </td>
                                    <td className="px-6 py-4">
                                        <select
            ...
            <div className="mt-8 text-center text-sm text-slate-500">
                Packaging items help calculate total cost of goods. Track inventory closely to never run out of supplies.
            </div>
        </>
    );
}
