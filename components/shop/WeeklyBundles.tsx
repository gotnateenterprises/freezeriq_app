                ...
                {bundles.map((bundle, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="mt-4 px-2 flex justify-between items-center border-t border-slate-100 dark:border-slate-800 pt-4">
                                <button onClick={() => onSelect?.(bundle.id)} className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors flex items-center gap-2 focus:outline-none">
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        onAddToCart({ bundleId: bundle.id }); // Using this prop alias to trigger the modal from the parent
                                    }}
                                    className="px-5 py-2.5 rounded-full text-white font-black text-[10px] uppercase tracking-widest shadow-md hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
